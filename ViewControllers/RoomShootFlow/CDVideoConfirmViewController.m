...
- (void)refreshOverviewUI {
    ...
    BOOL canSubmit = [CDVideoConfirmSubmissionPolicy canSubmitInDemo];
    self.submitBtn.enabled = canSubmit;
    if (canSubmit) {
        self.submitBtn.backgroundColor = [UIColor colorWithRed:26/255.0 green:102/255.0 blue:255/255.0 alpha:1.0];
        self.submitHintLabel.text = [CDVideoConfirmSubmissionPolicy demoSubmitHint];
    } else {
...
- (void)submitTapped {
    ...
    CD3DGSTrainingResultViewController *resultVC = [[CD3DGSTrainingResultViewController alloc] initWithSummary:summary];
